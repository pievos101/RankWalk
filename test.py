...
# KMeans
kmeans = KMeans(n_clusters=num_classes, random_state=42).fit(embeddings)
y_pred_kmeans = kmeans.labels_

# Ward hierarchical clustering (sklearn)
ward = AgglomerativeClustering(n_clusters=num_classes, linkage="ward")
y_pred_ward = ward.fit_predict(embeddings)
